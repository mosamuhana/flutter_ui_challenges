          ...
          child: Stack(
            ...
            children: <Widget>[
              Container(
                ...
                width: index == 0 ? deviceSize.width * 0.5 : deviceSize.width * 0.4,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0xFFE7E9EF).withOpacity(0.0), Color(0xFFE7E9EF)],
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    Material(
                      ...
                      child: Container(
                        // height: 110.0,
                        width: index == 0 ? deviceSize.width * 0.4 : deviceSize.width * 0.3,
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20.0),
                          // color: Colors.white,
                          gradient: LinearGradient(

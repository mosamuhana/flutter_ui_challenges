...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  SliverPadding _buildBookingsGrid() {
    return SliverPadding(
      ...
      sliver: SliverGrid(
        gridDelegate:
            SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 4, crossAxisSpacing: 16.0, mainAxisSpacing: 16.0),
  ...
  BottomExpandableAppBar _buildBottomBar(BuildContext context) {
    return BottomExpandableAppBar(
      ...
      bottomAppBarBody: Row(
        ...
        children: <Widget>[
          Expanded(
            child: _buildBottomMenuItem(icon: Icon(Icons.home), label: "Home", onTap: () {}),
          ),
          Expanded(
            child: _buildBottomMenuItem(icon: Icon(Icons.card_giftcard), label: "Bazaar", onTap: () {}),
          ),
          Expanded(
            child: _buildBottomMenuItem(icon: Icon(Icons.list), label: "Transactions", onTap: () {}),
          ),
          Expanded(
            child: _buildBottomMenuItem(icon: Icon(Icons.more_horiz), label: "More", onTap: () => controller.open()),
          ),
        ],
      ),
    );

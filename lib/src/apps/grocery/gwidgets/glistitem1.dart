  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(blurRadius: 10.0, color: Colors.grey.shade200, spreadRadius: 2.0)]),
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: Colors.yellow,
                        borderRadius:
                            BorderRadius.only(bottomLeft: Radius.circular(5.0), bottomRight: Radius.circular(5.0))),
                    child: Text(
                      "Add to Cart",

...
class TodoHomeOnePage extends StatelessWidget {
  ...
  final color1 = Color(0xffFA696C);
  final color2 = Color(0xffFA8165);
  final color3 = Color(0xffFB8964);
              ...
              child: OverflowBox(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Text(
                      "Tomorrow",
                      style: TextStyle(color: Colors.grey.shade400, fontSize: 45.0, fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
              ),

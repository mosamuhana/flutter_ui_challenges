            ...
            children: <Widget>[
              Text(
                ...
                style: Theme.of(context)
                    .textTheme
                    .headline6
                    .copyWith(color: Colors.white, fontSize: 24.0, fontWeight: FontWeight.normal),
              ),
              hSizedBox10,
              Text(
              ...
              RaisedButton(
                ...
                child: Text(
                  "Make order now",
                  style: TextStyle(color: Colors.white, fontSize: 18.0, letterSpacing: 1.50, fontWeight: FontWeight.normal),
                ),
                color: primary,
              ),
              hSizedBox20,

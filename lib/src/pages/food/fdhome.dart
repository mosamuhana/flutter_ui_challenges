          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.headline6.merge(TextStyle(fontSize: 14.0)),
              ),
              hSizedBox5,
              Text(
                restaurants[index]["specials"],
                style: Theme.of(context).textTheme.subtitle1.merge(TextStyle(fontSize: 12.0)),
              )
            ],
          ),
        );
      ...
      delegate: SliverChildBuilderDelegate((BuildContext context, int index) {
        return Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Container(height: 150.0, width: double.infinity, child: PNetworkImage(sliderItems[index], fit: BoxFit.cover)),
              hSizedBox10,
              Row(
                children: <Widget>[
                  Expanded(
                  ...
                  Text("Rs. 180",
                      style: Theme.of(context).textTheme.headline6.merge(TextStyle(fontSize: 16.0, color: Colors.red))),
                  IconButton(

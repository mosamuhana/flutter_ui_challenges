...
class _HomeScreenTopState extends State<HomeScreenTop> {
  final TextStyle dropdownMenuLabel = TextStyle(color: Colors.white, fontSize: 16);
    ...
    return Stack(
      children: <Widget>[
        ClipPath(
          ...
          child: Container(
            height: 350,
            decoration: BoxDecoration(gradient: LinearGradient(colors: [Color(0xfffb53c6), Color(0xffb91d73)])),
            child: Column(
              children: <Widget>[
                SizedBox(
                  height: 10,
                ...
                Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          fontFamily: 'OpenSans', fontSize: 24, color: Colors.white, fontWeight: FontWeight.normal),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                        ...
                        child: ChoiceChip(Icons.hotel, "Hotel", !isflightSelected)),
                  ],
                )
              ],
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: widget.isflightSelected
          ? BoxDecoration(color: Colors.white.withOpacity(.15), borderRadius: BorderRadius.all(Radius.circular(20)))
          : null,
      child: Row(
        children: <Widget>[
          Icon(
...
List<CityCard> cityCards = [
  CityCard(
      "https://cdn.pixabay.com/photo/2013/03/02/02/41/city-89197_960_720.jpg", "Kathmandu", "12 Feb", "10", "500", '440'),
  CityCard("https://cdn.pixabay.com/photo/2017/12/10/17/40/prague-3010407_960_720.jpg", "Bhaktapur", "12 Feb", "10", "500",
      '440'),
  CityCard(
      "https://cdn.pixabay.com/photo/2014/07/01/12/35/taxi-cab-381233_960_720.jpg", "Morang", "12 Feb", "10", "500", '440'),
];
              ...
              child: Container(
                decoration: BoxDecoration(
                    gradient: LinearGradient(
                        begin: Alignment.bottomCenter, end: Alignment.topCenter, colors: [Colors.black, Colors.black12])),
              ),
            ),
            Positioned(
              left: 10,

            ...
            children: <Widget>[
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            Text("Kathmandu", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)),
                            IconButton(
              ...
              Row(
                children: <Widget>[
                  ...
                  FlatButton(textColor: Colors.red, onPressed: () {}, child: Text("See All")),
                ],
              ),
              Container(
                height: 150.0,
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: GridView(
                        ...
                        children: <Widget>[
                          ClipRRect(
                              borderRadius: BorderRadius.circular(5.0), child: PNetworkImage(kathmandu1, fit: BoxFit.cover)),
                          ClipRRect(
                              borderRadius: BorderRadius.circular(5.0),

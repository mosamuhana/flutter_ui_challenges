    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          Container(
            height: 300,
            decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(mountEverest), fit: BoxFit.cover)),
          ),
          Container(
            height: 300,
          ...
          ListView(
            children: <Widget>[
              ...
              Text("Discover Nepal".toUpperCase(),
                  textAlign: TextAlign.center, style: TextStyle(fontSize: 24.0, color: Colors.white)),
              Text("Heaven is myth. Nepal is real.", textAlign: TextAlign.center, style: TextStyle(color: Colors.white)),
              SizedBox(
                height: 50.0,
              ),
              Container(
                    ...
                    Wrap(
                      ...
                      children: <Widget>[
                        Chip(
                          ...
                          label: Text("Pokhara".toUpperCase(), style: TextStyle(color: Colors.white)),
                        ),
                        Chip(

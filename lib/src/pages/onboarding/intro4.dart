    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          IconButton(
            icon: Icon(
              _currentIndex < _pageCount - 1 ? FontAwesomeIcons.arrowCircleRight : FontAwesomeIcons.checkCircle,
              size: 40,
            ),
            onPressed: () async {
  ...
  Widget _buildPage({String title, String icon}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(blurRadius: 10.0, spreadRadius: 5.0, offset: Offset(5.0, 5.0), color: Colors.black26)]),
      child: Column(

...
class LoginThreePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _facebookButton = RaisedButton(
      child: Text("Facebook"),
    ...
    final _twitterButton = RaisedButton(
      child: Text("Twitter"),
      textColor: Colors.white,
      color: Colors.indigo,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(40))),
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          Container(
            height: 650,
            child: RotatedBox(quarterTurns: 2, child: _wave),
          ),
          ListView(
            children: <Widget>[
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(color: Colors.white70, fontWeight: FontWeight.bold, fontSize: 28.0),
                    ),
                    _usernameField,
                    _passwordField,
                    _loginButton,

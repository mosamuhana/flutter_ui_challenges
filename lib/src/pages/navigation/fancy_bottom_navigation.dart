...
class _FancyBottomNavigationState extends State<FancyBottomNavigation> {
          ...
          Row(
            ...
            children: <Widget>[
              Padding(
                ...
                child: IconTheme(
                  data: IconThemeData(size: iconSize, color: isSelected ? backgroundColor : inactiveColor),
                  child: item.icon,
                ),
              ),
              isSelected
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: backgroundColor, boxShadow: [BoxShadow(color: Colors.black12, blurRadius: 2)]),
      child: Row(

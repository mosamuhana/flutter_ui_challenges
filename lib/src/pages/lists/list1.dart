...
class Item {
  ...
  Item({this.title, this.catagory, this.place, this.ratings, this.discount, this.image});
}
          ...
          child: Row(
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(item.image), fit: BoxFit.cover)),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      item.title,
                      style: TextStyle(color: Colors.deepOrange, fontWeight: FontWeight.w700, fontSize: 17),
                    ),
                    Text(
                      item.catagory,

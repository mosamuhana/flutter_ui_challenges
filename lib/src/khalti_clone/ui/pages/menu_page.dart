            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text.rich(
                    TextSpan(children: [TextSpan(text: "Rs "), TextSpan(text: "0", style: TextStyle(fontSize: 24.0))]),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 8.0, horizontal: 75.0),
                  child: Text.rich(
                    TextSpan(children: [TextSpan(text: "KP "), TextSpan(text: "0", style: TextStyle(fontSize: 20.0))]),
                    style: TextStyle(color: Colors.white),
                  ),
                ),
              ],
